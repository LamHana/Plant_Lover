                                    ...
                                    <div class="single-product-quantity">
                                        <form class="add-quantity" action="#">
                                            <div class="product-quantity">
                                                <input value="1" type="number" name="quantity" min="" />
                                            </div>
                                            <div class="add-to-link">
                                                <input type="hidden" name="productID" value="${requestScope.PRODUCT.productID}" required=""/>
                                                <input type="hidden" name="price" value="${requestScope.PRODUCT.price}" required=""/>
                                                <button class="product-btn" data-text="add to cart" type="submit" name="action" value="AddCart">
                                                    add to cart
                                                </button>
                                            </div>
                                        </form>
